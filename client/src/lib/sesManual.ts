...
export const SES_MANUAL_STEPS: SesManualStep[] = [
  {
    ...
    action: 'Abre “Configuración” y comprueba el código de arrendador. El código de establecimiento solo se informa si SES lo ha asignado a la sede; en caso contrario se utiliza la dirección estructurada.',
    result: 'La configuración queda disponible para todos los contratos de la organización.',
  ...
  },
  {
    ...
    action: 'Indica las fechas y pulsa “Preparar reservas”. PlanMint consulta los detalles disponibles en Rently, actualiza perfiles reutilizables, vehículos y lugares, y crea o refresca los borradores SES.',
    result: 'La tabla muestra un borrador por reserva, con su versión, estado y número exacto de datos pendientes.',
  ...
  },
  {
    ...
    action: 'Usa los contadores, la barra de completitud, el buscador, las fechas y el filtro de estado para localizar las reservas que requieren intervención.',
  ...
  },
  {
    ...
    result: 'Cuando no existe ningún error de validación, el contrato pasa automáticamente a “Listo”.',
  ...
  },
  {
    ...
    action: 'Marca exclusivamente contratos “Listos” y pulsa “Generar XML”. El servidor vuelve a validar, evita duplicados, genera el archivo y registra el lote y su huella.',
    result: 'El XML se descarga y el lote aparece en “Lotes y resultados”.',
  ...
  },
  {
    ...
    action: 'En el portal abre “Mis comunicaciones → Lote”. Cuando aparezca el resultado definitivo, registra cada contrato como aceptado o con error, copiando el código y el mensaje exactos.',
...
export const SES_GOLDEN_RULES = [
  ...
  'Solo los contratos “Listos” pueden entrar en un XML.',
