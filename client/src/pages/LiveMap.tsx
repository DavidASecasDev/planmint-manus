...
const LOCATION_ALIASES: Record<string, LocationAlias> = {
  'parking_g_aeropuerto': {
    coords: { lat: 39.5490, lng: 2.7250 },
    routingTarget: { lat: 39.5430, lng: 2.7180 },
    lastMileWaypoints: [
      [39.5430, 2.7180],  // Rotonda acceso suroeste
      [39.5445, 2.7195],  // Carretera acceso sur
      [39.5460, 2.7210],  // Continuación hacia el este
      [39.5475, 2.7225],  // Curva hacia parking
      [39.5485, 2.7240],  // Entrada parking G
      [39.5490, 2.7250],  // Centro Parking G
    ],
    extraMinutes: 3,
  },
};
                  ...
                  <Marker position={[AZUL_CARS_BASE.lat, AZUL_CARS_BASE.lng]} icon={baseIcon}>
                    <Popup>
                      <div className="text-sm">
                        ...
                        <p className="text-xs text-gray-500">{AZUL_CARS_BASE_LOCATION.addressLine}, {AZUL_CARS_BASE_LOCATION.district}</p>
                        <p className="text-xs text-gray-500">{AZUL_CARS_BASE_LOCATION.postalCode} {AZUL_CARS_BASE_LOCATION.municipalityName}, Illes Balears</p>
                      </div>
                    </Popup>
                  </Marker>
                </MapContainer>
            ...
            <div className="px-4 py-3 border-t" style={{ borderColor: brand.borderLight, backgroundColor: 'rgba(0,19,33,0.02)' }}>
              <div className="flex items-center gap-2.5">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <span className="text-[9px] text-gray-500 truncate">{AZUL_CARS_BASE_LOCATION.addressLine}, {AZUL_CARS_BASE_LOCATION.district} — {AZUL_CARS_BASE_LOCATION.municipalityName}</span>
                </div>
              </div>
            </div>
          </div>
