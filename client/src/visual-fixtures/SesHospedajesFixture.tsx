...
const FIXTURE_DRAFTS: SesContractDraft[] = [
  ...
  syntheticDraft({
    id: '14444444-4444-4444-8444-444444444444', reservation_id: '24444444-4444-4444-8444-444444444444',
    reference: '5592', external_booking_id: 5592, status: 'incomplete', operationalStatus: 'cancelled_not_applicable',
    readyForXml: false, ready_for_xml: false, validation_errors: [
      { path: 'holder.document_number', code: 'required', message: 'Falta documento' },
      { path: 'payment_type', code: 'required', message: 'Falta pago' },
    ], missingFields: [], invalidFields: [], vehicle_plate: 'CANCELADA',
  ...
  syntheticDraft({
    id: '15555555-5555-4555-8555-555555555555', reservation_id: '25555555-5555-4555-8555-555555555555',
    reference: 'SYNTHETIC-CANCELLED-OFFICIAL', external_booking_id: 65005, status: 'accepted',
    operationalStatus: 'xml_generated', readyForXml: false, ready_for_xml: false, vehicle_plate: 'HISTORICA',
    cancellationDisposition: {
      ...
      reasonCode: 'cancelled_with_official_history', label: 'Cancelada · revisar resultado oficial',
    },
  }),
];
