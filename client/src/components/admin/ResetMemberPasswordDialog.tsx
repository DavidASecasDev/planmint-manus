    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Establece una nueva contraseña para <strong>{memberName}</strong>.
            El usuario deberá usar esta contraseña en su próximo inicio de sesión.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            <Label htmlFor="new-member-password">Nueva contraseña</Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="confirm-member-password">Confirmar contraseña</Label>
            <Input
