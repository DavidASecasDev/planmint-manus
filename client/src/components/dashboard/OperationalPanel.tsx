import { useOperationalDashboard, TodayOperationRow } from '@/hooks/useOperationalDashboard';
import { useRentlySyncContextSafe } from '@/contexts/RentlySyncContext';
import { ManualPreparationList } from './ManualPreparationList';
