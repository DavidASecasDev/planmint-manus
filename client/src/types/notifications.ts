export type NotificationType = 'mention' | 'assignment' | 'reminder' | 'transfer_note' | 'transfer_status_change' | 'repair_update' | 'accident_report' | 'damage_report_update' | 'vehicle_prep_alert' | 'transfer_stale_alert' | 'invitation_sent' | 'invitation_accepted' | 'equipment_shortage' | 'en_camino_alert';
