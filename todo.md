...
- [x] Auditoría completa de la app: todos los triggers corregidos a SECURITY DEFINER (sync_fleet_vehicle_to_vehicles, auto_complete_preparation_on_vehicle_clean, generate_transfer_request_number, set_updated_at, update_equipment_updated_at, update_lost_found_updated_at, update_service_requests_updated_at), timeout Rently aumentado 45s→60s, 0 errores TypeScript, 1350 tests pasando, 0 errores en logs de producción
...
- [x] Añadir campo luggage_count (número de maletas) a transfer_items
