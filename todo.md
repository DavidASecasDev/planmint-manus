...
- [x] Feature: Navegación con flechas del teclado (arriba, abajo, izquierda, derecha) en la tabla de reservas para desplazarse sin usar la barra de scroll - implementado con onKeyDown en el contenedor de la tabla, detecta viewport de Radix ScrollArea, ignora flechas cuando hay input/textarea/select activo
