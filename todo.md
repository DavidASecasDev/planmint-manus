...
- [x] Bug CRÍTICO: Al cambiar de pestaña del navegador y volver a PlanMint, la página se refresca automáticamente perdiendo todo el trabajo no guardado - fix: throttle visibilitychange refresh a 5min, guard OfflineBanner reconnect con duración mínima 10s, desactivado refetchOnReconnect global
